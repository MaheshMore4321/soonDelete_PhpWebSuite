...
if(defined('SEE_PROCESS')) error_log("For information only : script refreshMySQL");
...
Type:separator; Caption: "MySQL Console prompt: ${mysqlConsolePromptUsed}"
Type: item; Caption: "${w_settings['mysqlUseConsolePrompt']}"; Glyph: 24; Action: multi; Actions: mysqlUseConsolePrompt
EOF;
$tpl = str_replace($myPattern,$myreplace,$tpl);
