<?php
//3.1.5 Copy php.ini into phpForApache.ini in case of copy instead of symlink

require 'config.inc.php';
require 'wampserver.lib.php';
if(defined('SEE_PROCESS')) error_log("For information only : script switchApacheVersion");
