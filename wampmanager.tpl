<?php
// Update 3.1.6 - Replace 0xA0 spaces by 0x20 spaces
// refreshSymlink.php added at start
...
Type: item; Caption: "MariaDB - MySQL"; Action: run; Filename: "%Windows%\Notepad.exe"; Parameters: "%AeTrayMenuPath%\mariadb_mysql.txt"; ShowCmd: Normal; Glyph: 22
...
Action: run; FileName: "${c_phpExe}"; Parameters: "msg.php compilerversions doreport";WorkingDir: "${c_installDir}/scripts"; Flags: waituntilterminated
